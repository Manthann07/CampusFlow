...
class LanguageService with ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'English': {
      ...
      'app_lock': 'App Lock',
      'app_lock_subtitle': 'Lock app when not in use',
      'device_management': 'Device Management',
      'active_sessions': 'Active Sessions',
      'sessions_subtitle': 'Manage your logged in devices',
      'password_reset_confirmation': 'Send a password reset link to',
      'send_link': 'Send Link',
      ...
      'room_floor_hint': 'e.g. 101',
      'floor_hint': 'e.g. Ground Floor',
      'status_updated': 'Status updated!',
      'location_updated': 'Location updated!',
      'book_with_faculty': 'Book with this Faculty',
      'edit_via_profile': 'Email cannot be changed after signup.',
    ...
    'Gujarati': {
      ...
      'login_security': 'લોગિન અને સુરક્ષા',
      'update_password_subtitle': 'તમારા એકાઉન્ટનો પાસવર્ડ અપડેટ કરો',
      'biometric_login': 'બાયોમેટ્રિક લોગિન',
      'biometric_subtitle': 'ફિંગરપ્રિન્ટ અથવા ફેસ આઈડીનો ઉપયોગ કરો',
      'extra_protection': 'વધારાની સુરક્ષા',
      'two_factor_auth': 'ટુ-ફેક્ટર ઓથોરીટી',
      'two_factor_subtitle': 'સુરક્ષાનું વધારાનું સ્તર ઉમેરો',
      'app_lock': 'એપ લોક',
      'app_lock_subtitle': 'એપ્લિકેશનનો ઉપયોગ ન હોય ત્યારે લોક કરો',
      'device_management': 'ડિવાઇસ મેનેજમેન્ટ',
      'active_sessions': 'સક્રિય સેશન્સ',
      'sessions_subtitle': 'તમારા લોગિન ડિવાઇસ મેનેજ કરો',
      'password_reset_confirmation': 'પાસવર્ડ રીસેટ લિંક મોકલો',
      'send_link': 'લિંક મોકલો',
      ...
      'refresh': 'રીફ્રેશ કરો',
      'live_status': 'લાઇવ સ્ટેટસ',
      'in_office': 'ઓફિસમાં',
      'in_meeting': 'મીટિંગમાં',
      'on_leave': 'રજા પર',
      'unavailable': 'અનુપલબ્ધ',
      'room_number': 'રૂમ નં.',
      'floor': 'માળ',
      'location_info': 'સ્થાન',
      'cabin_location': 'કેબિન સ્થાન',
      'room_floor_hint': 'ઉ.દ. 101',
      'floor_hint': 'ઉ.દ. ભૂ-માળ',
      'status_updated': 'સ્ટેટસ અપડેટ!',
      'location_updated': 'સ્થાન અપડેટ!',
      'book_with_faculty': 'આ ફેકલ્ટી સાથે બુક કરો',
      'edit_via_profile': 'નોંધણી પછી ઇમેઇલ બદલી શકાતું નથી.',
